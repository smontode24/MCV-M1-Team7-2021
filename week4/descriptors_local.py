...
def akace_descriptor(image, kp, mask, options):
    print("descriptors_local.py ==> akace_descriptor")
    """
    Extract descriptors from image using the AKACE method.
    # REF0:
    Args:
        image (ndarray): (H x W) 2D array of type np.uint8 containing a grayscale image.
        mask:
