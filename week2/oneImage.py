...
if __name__ == "__main__":
    ...
    eroded3 = cv2.erode(dst,kernel,iterations = 3)
    dilated3 = cv2.dilate(dst,kernel, iterations=3)
    ...
    output = cv2.drawContours(img2, big_contours, -1, (0, 255, 0), 1)
    #output2 = cv2.drawContours(img2, big_contours[19], -1, (0, 255, 0), 1)
    #output3 = cv2.drawContours(img2, big_contours[21], -1, (0, 255, 0), 1)
    print("hey bastard")
    '''
    ## HOUGH LINES:
